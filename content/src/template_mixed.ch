// Concept Template: MIXED layout (P3 2.2.8)
// Combines the standard teaching units with a visualization and two quizzes —
// the layout most real concepts converge on.
//   why -> model -> visualization -> retrieve -> apply -> connect
// Authors: copy this file, rename the render function, and fill in the units.
...
public func template_mixed() : string {
    ...
    #html {
        <div class="lesson template-mixed">
            <h1>Concept Title</h1>
            <div class="lesson-meta">20 min · Mixed · Module X of Y</div>

            <div class="unit unit-why">
                <h2>Why This Matters</h2>
                <p>The problem this concept solves.</p>
            </div>

            <div class="unit unit-model">
                <h2>A Simple Model</h2>
                <p>The simplified model before the full detail.</p>
            </div>
            ...
            <div class="viz-wrap" id="viz">
                <div class="viz-controls">
                    ...
                    <span class="viz-caption" id="viz-caption">Step 1 of 2</span>
                </div>
                <div class="viz-stage" id="viz-stage">Visualization goes here.</div>
            </div>
            ...
            <div class="unit unit-connect">
                <h2>Connect</h2>
                <p>How this concept links to the next one.</p>
            </div>
        </div>
    }

    #css {
        .lesson { max-width: 860px; margin: 0 auto; padding: 2rem; font-family: system-ui, -apple-system, sans-serif; line-height: 1.7; color: #111827; }
        ...
        p { margin: 0.5rem 0; }
        .viz-wrap { margin: 0 auto 2rem auto; max-width: 820px; background: #1e1e1e; color: #d4d4d4; border-radius: 10px; padding: 1.25rem; }
        ...
        .viz-stage { min-height: 140px; font-family: ui-monospace, monospace; background: #111827; border-radius: 6px; padding: 1rem; overflow-x: auto; }
    ...
    #js {
        var vizSteps = ['Step 1 content', 'Step 2 content'];
        var vizIndex = 0;
        function vizRender() {
