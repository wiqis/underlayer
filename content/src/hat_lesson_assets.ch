...
//
// Every HAT concept page emits its own 8-unit markup and then calls
// render_hat_lesson_css / render_hat_lesson_js so the course looks and behaves
// consistently. Same pattern as course_landing_assets.ch (markup lives in
// #html/#css/#js macros only — no string-built HTML).
//
