// ELF Course ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Concept 3: File Layout
...
public func render_file_layout() : string {
    var page = HtmlPage()
    page.defaultPrepare()
    var title = std::string_view("File Layout ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Underlayer")
    ...
    #html {
        ...
        <div class="lesson">
            ...
            <div class="unit unit-model">
                ...
                <ul>
                    <li><strong>A cover page</strong> (ELF header) ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â tells you what kind of book this is</li>
                    <li><strong>A table of contents</strong> (program header table) ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â tells the runtime where to find chapters</li>
                    <li><strong>The actual chapters</strong> (segments and sections) ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â the code and data</li>
                    <li><strong>A library catalog entry</strong> (section header table) ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â tells tools where to find specific sections</li>
                </ul>
            </div>
