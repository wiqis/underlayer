...
public func render_hat_landing() : string {
    ...
    #html {
        <div class="lesson hat-lesson">
            ...
            <div class="lesson-meta">6 modules · 47 concepts · Beginner to intermediate · English</div>
            ...
            <div class="module-list">
                <div class="unit unit-model">
                    ...
                    <p>What HAT-1 is, how it is weighted and paced, and how to plan and execute eight weeks of preparation.</p>
                ...
                <div class="unit unit-reality">
                    ...
                    <p>Arithmetic and number sense, percentages, ratio and rate, algebra, geometry, statistics, counting and probability, with a timed drill.</p>
                    <ul class="concept-list">
                ...
                <div class="unit unit-example">
                    ...
                    <p>Vocabulary, synonyms and antonyms, analogies, sentence and paragraph completion, grammar, idioms, reading comprehension, and a timed drill.</p>
                    <ul class="concept-list">
                ...
                <div class="unit unit-interact">
                    ...
                    <p>Critical reasoning and causation, deduction and puzzles, syllogisms, relations and directions, coding, data sufficiency and interpretation, series, and a timed drill.</p>
                    <ul class="concept-list">
                ...
                <div class="unit unit-apply">
                    ...
                    <p>Turning knowledge into a score: mock-test protocol, the error log, score targets and exam-day execution.</p>
                    <ul class="concept-list">
