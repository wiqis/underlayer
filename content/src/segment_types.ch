// ELF Course ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Concept 8: Segment Types
// PT_LOAD, PT_DYNAMIC, PT_INTERP ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â what each segment type does.
...
public func render_segment_types() : string {
    var page = HtmlPage()
    page.defaultPrepare()
    var title = std::string_view("Segment Types ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Underlayer")
    ...
    #html {
        <header role="banner">
            ...
            <div class="unit unit-model">
                ...
                <ul>
                    <li><strong>PT_LOAD</strong> ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â "Load this into memory" (code, data, BSS)</li>
                    <li><strong>PT_DYNAMIC</strong> ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â "This has dynamic linker info"</li>
                    <li><strong>PT_INTERP</strong> ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â "This is the path to the dynamic linker"</li>
                    <li><strong>PT_NOTE</strong> ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â "This has metadata/notes"</li>
                    <li><strong>PT_GNU_STACK</strong> ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â "This controls stack permissions"</li>
                </ul>
            </div>
            ...
            <div class="unit unit-reality">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr><td>PT_LOAD</td><td>1</td><td>Loadable segment ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â mapped into memory</td></tr>
  ...
  GNU_STACK ...     0x0000000000000000 RW   Stack (NX enabled)</pre>
            ...
            <div class="unit unit-retrieve">
                ...
                <div class="quiz" id="quiz-st-1">
                    <button class="quiz-option" onclick="checkQuiz('quiz-st-1', this, false)" aria-label="Option: PT_DYNAMIC">PT_DYNAMIC</button>
                    <button class="quiz-option" onclick="checkQuiz('quiz-st-1', this, true)" aria-label="Option: PT_INTERP">PT_INTERP</button>
                    <button class="quiz-option" onclick="checkQuiz('quiz-st-1', this, false)" aria-label="Option: PT_LOAD">PT_LOAD</button>
            ...
            <div class="unit unit-apply">
                ...
                <div class="quiz" id="quiz-st-2">
                    <button class="quiz-option" onclick="checkQuiz('quiz-st-2', this, false)" aria-label="Option: 1 ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â they're all mapped together">1 ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â they're all mapped together</button>
                    <button class="quiz-option" onclick="checkQuiz('quiz-st-2', this, true)" aria-label="Option: 3 ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â each PT_LOAD becomes a separate mmap region">3 ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â each PT_LOAD becomes a separate mmap region</button>
                    <button class="quiz-option" onclick="checkQuiz('quiz-st-2', this, false)" aria-label="Option: It depends on the page size">It depends on the page size</button>
                    <div class="quiz-feedback"></div>
                </div>
            </div>
