...
$ objdump -d /bin/ls | head -20  # See the disassembly at the entry point</code></pre>
            ...
            <div class="unit unit-retrieve">
                ...
                <div class="quiz" id="quiz-ep-1">
                    <button class="quiz-option" onclick="checkQuiz('quiz-ep-1', this, false)" aria-label="Option: The main() function">The main() function</button>
                    <button class="quiz-option" onclick="checkQuiz('quiz-ep-1', this, true)" aria-label="Option: The _start / initialization code">The _start / initialization code</button>
                    <button class="quiz-option" onclick="checkQuiz('quiz-ep-1', this, false)" aria-label="Option: The first instruction of .text">The first instruction of .text</button>
            ...
            <div class="unit unit-apply">
                ...
                <div class="quiz" id="quiz-ep-2">
                    <button class="quiz-option" onclick="checkQuiz('quiz-ep-2', this, false)" aria-label="Option: It will crash immediately">It will crash immediately</button>
                    <button class="quiz-option" onclick="checkQuiz('quiz-ep-2', this, true)" aria-label="Option: It may run but skip initialization (ctors, libc setup)">It may run but skip initialization (ctors, libc setup)</button>
                    <button class="quiz-option" onclick="checkQuiz('quiz-ep-2', this, false)" aria-label="Option: The kernel will refuse to execute it">The kernel will refuse to execute it</button>
                    <div class="quiz-feedback"></div>
                </div>
            </div>
            ...
            <div class="unit unit-retrieve">
                ...
                <div class="tf-quiz" id="tf-ep-1">
                    <button class="tf-option" onclick="checkTF('tf-ep-1', false, 'The entry point points to _start (libc startup code), which eventually calls main(). Directly jumping to main() would skip critical initialization like setting up the C runtime, global constructors, and argument parsing.')" aria-label="Option: True">True</button>
                    <button class="tf-option" onclick="checkTF('tf-ep-1', true, 'The entry point points to _start (libc startup code), which eventually calls main(). Directly jumping to main() would skip critical initialization like setting up the C runtime, global constructors, and argument parsing.')" aria-label="Option: False">False</button>
            ...
            <div class="unit unit-retrieve">
                ...
                <div class="tf-quiz" id="tf-ep-2">
                    <button class="tf-option" onclick="checkTF('tf-ep-2', true, 'PIE executables are loaded at a random base address chosen by the kernel. The entry point is a relative offset from that base, so values like 0x1060 are common. Non-PIE executables use fixed virtual addresses like 0x401060.')" aria-label="Option: True">True</button>
                    <button class="tf-option" onclick="checkTF('tf-ep-2', false, 'PIE executables are loaded at a random base address chosen by the kernel. The entry point is a relative offset from that base, so values like 0x1060 are common. Non-PIE executables use fixed virtual addresses like 0x401060.')" aria-label="Option: False">False</button>
                    <div class="tf-feedback"></div>
                </div>
            </div>
    ...
    #js {
        ...
        function checkTF(quizId, correct, explanation) {
            ...
            if(correct) {
                ...
                feedback.style.background = 'rgb(236,253,245)';
                feedback.style.color = 'rgb(5,150,105)';
            } else {
                clickedBtn.classList.add('wrong');
                feedback.textContent = 'False. ' + explanation;
                feedback.style.background = 'rgb(254,242,242)';
                feedback.style.color = 'rgb(220,38,38)';
            }
