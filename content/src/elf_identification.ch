// ELF Course ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Concept 4: ELF Identification
// The e_ident array ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â magic number, class, data encoding, OS/ABI.
...
public func render_elf_identification() : string {
    var page = HtmlPage()
    page.defaultPrepare()
    var title = std::string_view("ELF Identification ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Underlayer")
    ...
    #html {
        ...
        <div class="lesson">
            ...
            <div class="unit unit-model">
                ...
                <ul>
                    <li><strong>Bytes 0-3:</strong> Magic number ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â <code>7f 45 4c 46</code> (spells ".ELF")</li>
                    <li><strong>Byte 4:</strong> Class ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â 1 = 32-bit, 2 = 64-bit</li>
                    <li><strong>Byte 5:</strong> Data encoding ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â 1 = little-endian, 2 = big-endian</li>
                    <li><strong>Byte 6:</strong> ELF version ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â always 1</li>
                    <li><strong>Byte 7:</strong> OS/ABI ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â 0 = System V, 3 = Linux, 6 = Solaris, etc.</li>
                </ul>
            </div>
